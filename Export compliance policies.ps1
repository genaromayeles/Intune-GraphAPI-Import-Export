...
try {
    ...
    foreach ($policy in $compliancePolicies) {
        $filePath = "$($logfolder)\Compliance - $($policy.displayName).json"
...
Write-Host "Compliance Policies with custom compliance settings successfully exported!" -ForegroundColor Yellow
